...
@section('content')
    ...
    <div class="card text-white bg-dark mb-3" style="max-width: 70rem;">        
        <div class="card-body">
            <h5 class="card-title" style="text-align: center">GESTIONAR RUTAS</h5>
            ...
            <p class="card-text">Desde este menú puedes crear, editar, listar y eliminar rutas de la aerolínea.</p>
            <div class="d-grid gap-2 d-md-flex justify-content-md-end" >
                <a class="btn btn-dark" href="{{ url('/adminrutas/crearruta') }}" role="button"><i class="bi bi-plus-circle"></i></i>  Crear Ruta</a>
                <a class="btn btn-dark" href="{{ url('../login') }}" role="button"><i class="bi bi-arrow-left-circle"></i>  Cerrar Sesión</a>
            </div>
        </div>
    </div>
    <h2 class="text-light" style="text-align: center">RUTAS DISPONIBLES</h2>
